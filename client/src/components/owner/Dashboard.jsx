...
const dashboardsCards = [
  ...
  {title: "Pending" , value: data.pendingBookings,icon: assets.cautionIconColred},
      ...
      <div className="flex flex-wrap items-start gap-6 mb-8 w-full">
        ...
        <div className="p-4 md:p-6  border border-borderColor rounded-md max-w-lg w-full">
          ...
          {data.recentBookings.map((booking, index)=>(
            <div key={index} className="mt-4 flex items-center jsutify-between">
              <div classname="flex items-cenetr gap-2">
                <div className="hidden md:flex items-center jsutify-center w-12 h-12rounded-full
                bg-primary/10">
